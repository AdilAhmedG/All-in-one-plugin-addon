...
if( ! class_exists( 'PEWC_Settings_Tab' ) ) {
	...
	class PEWC_Settings_Tab {
		...
		public function get_settings() {
			...
			} else if( $current_section == 'pewc_image' ) {

				$settings = pewc_get_image_settings();
			...
			} else if ( $current_section == 'pewc_integrations' ) {

				$settings = pewc_get_integrations_settings();

			} else if ( $current_section == 'pewc_optimised_validation' ) {
